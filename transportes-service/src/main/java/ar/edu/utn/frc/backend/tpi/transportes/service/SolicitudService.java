...
import ar.edu.utn.frc.backend.tpi.transportes.dto.SolicitudRequest;
import ar.edu.utn.frc.backend.tpi.transportes.dto.SolicitudResponse;
...
import ar.edu.utn.frc.backend.tpi.transportes.entity.EstadoSolicitud;
...
import ar.edu.utn.frc.backend.tpi.transportes.repository.ContenedorRepository;
...
public class SolicitudService {
    ...
    private SolicitudResponse mapToResponse(Solicitud solicitud) {
        return ar.edu.utn.frc.backend.tpi.transportes.mapper.SolicitudMapper.toResponse(solicitud);
    }
}
